        ...
        <div class="header-left d-flex justify-content-between">
          ...
          <div class="header-search">
            ...
            <ul class="d-flex justify-content-center">
              ...
              <li><a href="video.php"><i class="fas fa-video on-now"></i></a></li>
             
            </ul>
          </div>
        <div class="header-right d-flex justify-content-between">
          <div class="user-img">
           <a href="profile/user_pr.php?user=<?= $user['username'] ?>&id_user=<?= $user['user_id'] ?>"><img src="./uploads/<?= $user['p_p'] ?>" alt=""></a> 
          </div>
          <div class="chat-icon">
